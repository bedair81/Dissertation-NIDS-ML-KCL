...
\begin{figure}[H]
    ...
    \node (evaluation1) [rectangle, rounded corners, text centered, draw=black, below left=0.5cm of trainedmodel] {Evaluation on CICIDS2017 Testing Set};
    \node (evaluation2) [rectangle, rounded corners, text centered, draw=black, below right=0.5cm of trainedmodel] {Evaluation on CTU13 Dataset};
...
\node (evaluation1) [rectangle, rounded corners, text centered, draw=black, below left=0.5cm of shap] {Evaluation on CICIDS2017 Testing Set};
\node (evaluation2) [rectangle, rounded corners, text centered, draw=black, below right=0.5cm of shap] {Evaluation on CTU13 Dataset};
